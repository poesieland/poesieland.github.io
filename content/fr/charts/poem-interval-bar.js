...
(async function () {
  const data = [
    { label: 'Moins d\'un jour', value: 171, color: 'rgba(72, 149, 239, 1)' },
    { label: 'Un jour', value: 273, color: 'rgba(72, 149, 239, 0.9)' },
    { label: '2j', value: 134, color: 'rgba(72, 149, 239, 0.7)' },
    { label: '3j', value: 96, color: 'rgba(72, 149, 239, 0.7)' },
    { label: '4j', value: 64, color: 'rgba(72, 149, 239, 0.7)' },
    { label: '5j', value: 47, color: 'rgba(72, 149, 239, 0.7)' },
    { label: '6j', value: 26, color: 'rgba(72, 149, 239, 0.7)' },
    { label: '7j', value: 19, color: 'rgba(72, 149, 239, 0.7)' },
