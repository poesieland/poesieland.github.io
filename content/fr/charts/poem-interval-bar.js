...
(async function () {
  const data = [
    { label: 'Moins d\'un jour', value: 168, color: 'rgba(72, 149, 239, 1)' },
    { label: 'Un jour', value: 262, color: 'rgba(72, 149, 239, 0.9)' },
    { label: '2j', value: 130, color: 'rgba(72, 149, 239, 0.7)' },
    { label: '3j', value: 94, color: 'rgba(72, 149, 239, 0.7)' },
    { label: '4j', value: 63, color: 'rgba(72, 149, 239, 0.7)' },
