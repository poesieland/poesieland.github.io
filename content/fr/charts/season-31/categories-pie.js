...
(async function () {
  const data = [
    ...
    { label: 'Condition humaine', value: 3, color: 'rgba(105, 16, 168, 1)' },
    ...
    { label: 'Félinement vôtre', value: 9, color: 'rgba(161, 86, 28, 1)' },
    { label: 'Printemps', value: 7, color: 'rgba(130, 196, 108, 1)' },
    { label: 'Hiver', value: 2, color: 'rgba(24, 57, 30, 1)' },
  ];
  addPieChart('season31Pie', [data], { plugins: { title: { display: true, text: 'Emotions mouvantes (31) janvier à mars 2026' } } });
})();
