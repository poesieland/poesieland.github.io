...
(async function () {
  const data = [
    ...
    { label: 'Aube', value: 5, color: 'rgba(255, 163, 0, 1)' },
    ...
    { label: 'Automne', value: 24, color: 'rgba(27, 79, 8, 1)' },
    { label: 'Hiver', value: 1, color: 'rgba(24, 57, 30, 1)' },
  ];
  addPieChart('season29Pie', [data], { plugins: { title: { display: true, text: 'Kaléidoscopes (29) septembre à novembre 2025' } } });
})();
