...
(async function () {
  ...
  addRadarChart('poemDay-crepusculeRadar', ['Poèmes selon le jour de l\'année'], [data], { backgroundColor: 'rgba(166, 60, 6, 0.5)', borderColor: 'rgba(166, 60, 6, 1)', pointBackgroundColor: 'rgba(166, 60, 6, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
