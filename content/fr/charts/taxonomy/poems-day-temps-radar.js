...
(async function () {
  ...
  addRadarChart('poemDay-tempsRadar', ['Mois les plus représentés : août, avril, janvier, septembre'], [data], { backgroundColor: 'rgba(140, 7, 221, 0.5)', borderColor: 'rgba(140, 7, 221, 1)', pointBackgroundColor: 'rgba(140, 7, 221, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
