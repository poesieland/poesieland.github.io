...
(async function () {
  ...
  addRadarChart('poemDay-felinement_votreRadar', ['Mois les plus représentés : janvier, décembre, mars, août'], [data], { backgroundColor: 'rgba(161, 86, 28, 0.5)', borderColor: 'rgba(161, 86, 28, 1)', pointBackgroundColor: 'rgba(161, 86, 28, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
