...
(async function () {
  ...
  addRadarChart('poemDay-amour_platoniqueRadar', ['Mois les plus représentés : février, septembre, janvier, juin'], [data], { backgroundColor: 'rgba(255, 111, 125, 0.5)', borderColor: 'rgba(255, 111, 125, 1)', pointBackgroundColor: 'rgba(255, 111, 125, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
