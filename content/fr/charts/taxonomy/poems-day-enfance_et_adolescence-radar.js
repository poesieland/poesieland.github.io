...
(async function () {
  ...
  addRadarChart('poemDay-enfance_et_adolescenceRadar', ['Mois les plus représentés : janvier, mai, juin, septembre'], [data], { backgroundColor: 'rgba(234, 191, 250, 0.5)', borderColor: 'rgba(234, 191, 250, 1)', pointBackgroundColor: 'rgba(234, 191, 250, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
