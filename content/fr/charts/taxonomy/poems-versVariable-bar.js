...
(async function () {
  const data = [
    { label: 'Premiers élans (1) ', value: 1, color: 'rgba(72, 149, 239, 1)' },
    ...
    { label: 'Au long cours (14) ', value: 1, color: 'rgba(72, 149, 239, 1)' },
    { label: 'De place en place (15) 2001', value: 1, color: 'rgba(72, 149, 239, 1)' },
    { label: 'Plus loin (16) ', value: 1, color: 'rgba(72, 149, 239, 1)' },
    { label: 'Traversées (17) ', value: 1, color: 'rgba(72, 149, 239, 1)' },
    ...
    { label: 'Les mots respirent (24) 2024-25', value: 2, color: 'rgba(72, 149, 239, 1)' },
  ];
