...
(async function () {
  ...
  addRadarChart('poemDay-villeRadar', ['Poèmes selon le jour de l\'année'], [data], { backgroundColor: 'rgba(152, 151, 88, 0.5)', borderColor: 'rgba(152, 151, 88, 1)', pointBackgroundColor: 'rgba(152, 151, 88, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
