...
(async function () {
  ...
  addRadarChart('poemDay-villeRadar', ['Poèmes selon le jour de l\'année'], [data], { backgroundColor: 'rgba(195, 111, 9, 0.5)', borderColor: 'rgba(195, 111, 9, 1)', pointBackgroundColor: 'rgba(195, 111, 9, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
