...
(async function () {
  ...
  addRadarChart('poemDay-luneRadar', ['Mois les plus représentés : février, août, janvier, mars'], [data], { backgroundColor: 'rgba(253, 241, 184, 0.5)', borderColor: 'rgba(253, 241, 184, 1)', pointBackgroundColor: 'rgba(253, 241, 184, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
