...
(async function () {
  ...
  addRadarChart('poemDay-apprentissageRadar', ['Mois les plus représentés : mars, janvier, avril, mai'], [data], { backgroundColor: 'rgba(70, 24, 115, 0.5)', borderColor: 'rgba(70, 24, 115, 1)', pointBackgroundColor: 'rgba(70, 24, 115, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
