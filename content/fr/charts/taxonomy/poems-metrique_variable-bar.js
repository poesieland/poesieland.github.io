...
(async function () {
  const data = [
    ...
    { label: 'Tempo piano (12) 1999', value: 1, color: 'rgba(72, 149, 239, 1)' },
    ...
    { label: 'Kaléidoscopes (29) 2025', value: 5, color: 'rgba(72, 149, 239, 1)' },
    { label: 'Tout fait sens (30) 2025-26', value: 3, color: 'rgba(72, 149, 239, 1)' },
    { label: 'Emotions mouvantes (31) 2026', value: 1, color: 'rgba(72, 149, 239, 1)' },
    { label: 'Témoin jour après jour (32) 2026', value: 0, color: 'rgba(72, 149, 239, 1)' },
    { label: 'La musique des mots (33) 2026', value: 1, color: 'rgba(72, 149, 239, 1)' },
    { label: 'A mi-chemin du paradis (34) 2026', value: 6, color: 'rgba(72, 149, 239, 1)' },
    { label: 'Un jour à la fois (35) 2026', value: 0, color: 'rgba(72, 149, 239, 1)' },
  ];
