...
(async function () {
  ...
  addRadarChart('poemDay-ombres_et_lumieresRadar', ['Mois les plus représentés : août, juin, février, novembre'], [data], { backgroundColor: 'rgba(255, 203, 96, 0.5)', borderColor: 'rgba(255, 203, 96, 1)', pointBackgroundColor: 'rgba(255, 203, 96, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
