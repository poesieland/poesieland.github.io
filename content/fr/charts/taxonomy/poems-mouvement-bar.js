...
(async function () {
  const data = [
    { label: 'Premiers élans (1) ', value: 1, color: 'rgba(250, 152, 70, 0.5)' },
    ...
    { label: 'Au long cours (14) ', value: 4, color: 'rgba(250, 152, 70, 0.5)' },
    { label: 'De place en place (15) 2001', value: 0, color: 'rgba(250, 152, 70, 0.5)' },
    { label: 'Plus loin (16) ', value: 0, color: 'rgba(250, 152, 70, 0.5)' },
    { label: 'Traversées (17) ', value: 0, color: 'rgba(250, 152, 70, 0.5)' },
