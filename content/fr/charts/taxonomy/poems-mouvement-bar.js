...
(async function () {
  const data = [
    { label: 'Premiers élans (1) 1994-96', value: 1, color: 'rgba(250, 152, 70, 0.5)' },
    ...
    { label: 'Espaces de vie (5) 1997-98', value: 0, color: 'rgba(250, 152, 70, 0.5)' },
    ...
    { label: 'Pensées (10) 1998-99', value: 1, color: 'rgba(250, 152, 70, 0.5)' },
    ...
    { label: 'Plus loin (16) 2002-04', value: 0, color: 'rgba(250, 152, 70, 0.5)' },
    { label: 'Traversées (17) 2004-23', value: 0, color: 'rgba(250, 152, 70, 0.5)' },
    { label: 'Retour aux sources (18) 2023-24', value: 0, color: 'rgba(250, 152, 70, 0.5)' },
    ...
    { label: 'Les mots respirent (24) 2024-25', value: 1, color: 'rgba(250, 152, 70, 0.5)' },
    { label: 'Coeur et âme (25) 2025', value: 1, color: 'rgba(250, 152, 70, 0.5)' },
