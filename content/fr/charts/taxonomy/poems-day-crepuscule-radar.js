...
(async function () {
  ...
  addRadarChart('poemDay-crepusculeRadar', ['Mois les plus représentés : août, juillet, juin, novembre'], [data], { backgroundColor: 'rgba(179, 103, 0, 0.5)', borderColor: 'rgba(179, 103, 0, 1)', pointBackgroundColor: 'rgba(179, 103, 0, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
