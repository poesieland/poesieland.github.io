...
(async function () {
  const data = [
    ...
    { label: 'Vivace (3) 1997', value: 1, color: 'rgba(72, 149, 239, 0.5)' },
    ...
    { label: 'Au long cours (14) 1999-2001', value: 1, color: 'rgba(72, 149, 239, 0.5)' },
    { label: 'De place en place (15) 2001', value: 1, color: 'rgba(72, 149, 239, 0.5)' },
    { label: 'Plus loin (16) 2002-04', value: 1, color: 'rgba(72, 149, 239, 0.5)' },
    ...
    addBarChart('poems-metric9Bar', ['Poèmes au fil des saisons'], [data], {scales: { y: { ticks: { stepSize: 1 } } }});
})();
