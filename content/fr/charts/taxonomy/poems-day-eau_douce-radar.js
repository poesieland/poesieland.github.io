...
(async function () {
  ...
  addRadarChart('poemDay-eau_douceRadar', ['Mois les plus représentés : juin, mai, août, janvier'], [data], { backgroundColor: 'rgba(0, 127, 255, 0.5)', borderColor: 'rgba(0, 127, 255, 1)', pointBackgroundColor: 'rgba(0, 127, 255, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
