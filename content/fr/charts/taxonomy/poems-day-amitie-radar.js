...
(async function () {
  ...
  addRadarChart('poemDay-amitieRadar', ['Mois les plus représentés : mai, avril, janvier, mars'], [data], { backgroundColor: 'rgba(255, 194, 209, 0.5)', borderColor: 'rgba(255, 194, 209, 1)', pointBackgroundColor: 'rgba(255, 194, 209, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
