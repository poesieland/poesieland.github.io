...
(async function () {
  ...
  addRadarChart('poemDay-aubeRadar', ['Mois les plus représentés : novembre, août, octobre, janvier'], [data], { backgroundColor: 'rgba(255, 163, 0, 0.5)', borderColor: 'rgba(255, 163, 0, 1)', pointBackgroundColor: 'rgba(255, 163, 0, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
