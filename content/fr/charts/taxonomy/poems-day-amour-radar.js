...
(async function () {
  ...
  addRadarChart('poemDay-amourRadar', ['Mois les plus représentés : juillet, août, février, mai'], [data], { backgroundColor: 'rgba(253, 108, 158, 0.5)', borderColor: 'rgba(253, 108, 158, 1)', pointBackgroundColor: 'rgba(253, 108, 158, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
