...
(async function () {
  ...
  addRadarChart('poemDay-revolteRadar', ['Mois les plus représentés : juin, juillet, octobre, mai'], [data], { backgroundColor: 'rgba(61, 0, 102, 0.5)', borderColor: 'rgba(61, 0, 102, 1)', pointBackgroundColor: 'rgba(61, 0, 102, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
