...
(async function () {
  ...
  addRadarChart('poemDay-angoisseRadar', ['Poèmes selon le jour de l\'année'], [data], { backgroundColor: 'rgba(38, 9, 78, 0.5)', borderColor: 'rgba(38, 9, 78, 1)', pointBackgroundColor: 'rgba(38, 9, 78, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
