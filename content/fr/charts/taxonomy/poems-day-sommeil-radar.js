...
(async function () {
  ...
  addRadarChart('poemDay-sommeilRadar', ['Mois les plus représentés : février, juin, août, septembre'], [data], { backgroundColor: 'rgba(209, 98, 4, 0.5)', borderColor: 'rgba(209, 98, 4, 1)', pointBackgroundColor: 'rgba(209, 98, 4, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
