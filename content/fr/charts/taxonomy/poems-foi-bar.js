...
(async function () {
  const data = [
    ...
    { label: 'Cinquième Saison : Espaces de vie (1997 - 1998)', value: 1, color: 'rgba(203, 93, 241, 0.5)' },
    ...
    { label: 'Quinzième Saison : De place en place (2001)', value: 2, color: 'rgba(203, 93, 241, 0.5)' },
    ...
    { label: 'Vingtième Saison : Le temps qui nous reste (2024)', value: 4, color: 'rgba(203, 93, 241, 0.5)' },
    { label: 'Vingt-et-unième Saison : C\'est vivre qui compte (2024)', value: 2, color: 'rgba(203, 93, 241, 0.5)' },
    { label: 'Vingt-deuxième Saison : Au temps le dire (2024)', value: 3, color: 'rgba(203, 93, 241, 0.5)' },
    { label: 'Vingt-troisième Saison : Jamais trop (2024)', value: 12, color: 'rgba(203, 93, 241, 0.5)' },
    { label: 'Vingt-quatrième Saison : Les mots respirent (2024 - 2025)', value: 2, color: 'rgba(203, 93, 241, 0.5)' },
  ];
