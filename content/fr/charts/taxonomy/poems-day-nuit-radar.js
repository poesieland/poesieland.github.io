...
(async function () {
  ...
  addRadarChart('poemDay-nuitRadar', ['Mois les plus représentés : juin, septembre, mars, février'], [data], { backgroundColor: 'rgba(47, 27, 12, 0.5)', borderColor: 'rgba(47, 27, 12, 1)', pointBackgroundColor: 'rgba(47, 27, 12, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
