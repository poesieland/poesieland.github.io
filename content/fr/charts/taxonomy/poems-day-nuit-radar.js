...
(async function () {
  ...
  addRadarChart('poemDay-nuitRadar', ['Poèmes selon le jour de l\'année'], [data], { backgroundColor: 'rgba(113, 0, 0, 0.5)', borderColor: 'rgba(113, 0, 0, 1)', pointBackgroundColor: 'rgba(113, 0, 0, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
