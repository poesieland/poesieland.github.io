...
(async function () {
  const data = [
    { label: 'Premiers élans (1) (1994 - 1996)', value: 2, color: 'rgba(27, 79, 8, 0.5)' },
    ...
    { label: 'Espaces de vie (5) (1997 - 1998)', value: 4, color: 'rgba(27, 79, 8, 0.5)' },
    ...
    { label: 'Pensées (10) (1999)', value: 0, color: 'rgba(27, 79, 8, 0.5)' },
    ...
    { label: 'Au long cours (14) (1999 - 2001)', value: 3, color: 'rgba(27, 79, 8, 0.5)' },
    { label: 'De place en place (15) (2001)', value: 4, color: 'rgba(27, 79, 8, 0.5)' },
    { label: 'Plus loin (16) (2002 - 2004)', value: 7, color: 'rgba(27, 79, 8, 0.5)' },
    { label: 'Traversées (17) (2004 - 2023)', value: 8, color: 'rgba(27, 79, 8, 0.5)' },
    { label: 'Retour aux sources (18) (2023 - 2024)', value: 8, color: 'rgba(27, 79, 8, 0.5)' },
    ...
    { label: 'Les mots respirent (24) (2024 - 2025)', value: 0, color: 'rgba(27, 79, 8, 0.5)' },
  ];
