...
(async function () {
  const data = [
    { label: 'Premiers élans (1) ', value: 2, color: 'rgba(27, 79, 8, 0.5)' },
    ...
    { label: 'Au long cours (14) ', value: 3, color: 'rgba(27, 79, 8, 0.5)' },
    { label: 'De place en place (15) 2001', value: 4, color: 'rgba(27, 79, 8, 0.5)' },
    { label: 'Plus loin (16) ', value: 7, color: 'rgba(27, 79, 8, 0.5)' },
    { label: 'Traversées (17) ', value: 8, color: 'rgba(27, 79, 8, 0.5)' },
