...
(async function () {
  ...
  addRadarChart('poemDay-fauneRadar', ['Mois les plus représentés : octobre, septembre, décembre, janvier'], [data], { backgroundColor: 'rgba(4, 139, 154, 0.5)', borderColor: 'rgba(4, 139, 154, 1)', pointBackgroundColor: 'rgba(4, 139, 154, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
