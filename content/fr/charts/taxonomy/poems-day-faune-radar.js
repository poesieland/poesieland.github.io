...
(async function () {
  ...
  addRadarChart('poemDay-fauneRadar', ['Poèmes selon le jour de l\'année'], [data], { backgroundColor: 'rgba(9, 61, 55, 0.5)', borderColor: 'rgba(9, 61, 55, 1)', pointBackgroundColor: 'rgba(9, 61, 55, 1)', pointBorderColor: '#fff', pointHoverBackgroundColor: '#fff', pointHoverBorderColor: 'rgb(54, 162, 235)', elements: { line: { borderWidth: 1  } }, scales: { r: { ticks: { stepSize: 1 } } } });
})();
