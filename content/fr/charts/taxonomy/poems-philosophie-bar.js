...
(async function () {
  const data = [
    { label: 'Premiers élans (1) ', value: 24, color: 'rgba(220, 147, 246, 0.5)' },
    ...
    { label: 'Espaces de vie (5) 1997-98', value: 22, color: 'rgba(220, 147, 246, 0.5)' },
    ...
    { label: 'Au long cours (14) ', value: 26, color: 'rgba(220, 147, 246, 0.5)' },
    { label: 'De place en place (15) 2001', value: 31, color: 'rgba(220, 147, 246, 0.5)' },
    { label: 'Plus loin (16) ', value: 24, color: 'rgba(220, 147, 246, 0.5)' },
    { label: 'Traversées (17) ', value: 24, color: 'rgba(220, 147, 246, 0.5)' },
    { label: 'Retour aux sources (18) 2023-24', value: 19, color: 'rgba(220, 147, 246, 0.5)' },
    ...
    { label: 'Les mots respirent (24) 2024-25', value: 22, color: 'rgba(220, 147, 246, 0.5)' },
  ];
