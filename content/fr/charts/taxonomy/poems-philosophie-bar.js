...
(async function () {
  const data = [
    ...
    { label: 'Vingt-troisième Saison : Jamais trop (2024)', value: 29, color: 'rgba(220, 147, 246, 0.5)' },
    { label: 'Vingt-quatrième Saison : Les mots respirent (2024)', value: 4, color: 'rgba(220, 147, 246, 0.5)' },
  ];
