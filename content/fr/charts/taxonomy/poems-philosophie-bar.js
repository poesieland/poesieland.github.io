...
(async function () {
  const data = [
    ...
    { label: 'Vingt-deuxième Saison : Au temps le dire (2024)', value: 21, color: 'rgba(220, 147, 246, 0.5)' },
    { label: 'Vingt-troisième Saison : Jamais trop (2024)', value: 30, color: 'rgba(220, 147, 246, 0.5)' },
    { label: 'Vingt-quatrième Saison : Les mots respirent (2024 - 2025)', value: 16, color: 'rgba(220, 147, 246, 0.5)' },
  ];
