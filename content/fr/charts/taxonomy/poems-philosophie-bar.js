...
(async function () {
  const data = [
    ...
    { label: 'Cinquième Saison : Espaces de vie (1997 - 1998)', value: 22, color: 'rgba(220, 147, 246, 0.5)' },
    ...
    { label: 'Dix-huitième Saison : Retour aux sources (2023 - 2024)', value: 18, color: 'rgba(220, 147, 246, 0.5)' },
    { label: 'Dix-neuvième Saison : Destination bonheur (2024)', value: 26, color: 'rgba(220, 147, 246, 0.5)' },
    { label: 'Vingtième Saison : Le temps qui nous reste (2024)', value: 15, color: 'rgba(220, 147, 246, 0.5)' },
  ];
