...
(async function () {
  const data = [
    { label: 'Premiers élans (1) ', value: 5, color: 'rgba(121, 248, 248, 0.5)' },
    ...
    { label: 'Au long cours (14) ', value: 6, color: 'rgba(121, 248, 248, 0.5)' },
    { label: 'De place en place (15) 2001', value: 4, color: 'rgba(121, 248, 248, 0.5)' },
    { label: 'Plus loin (16) ', value: 8, color: 'rgba(121, 248, 248, 0.5)' },
    { label: 'Traversées (17) ', value: 3, color: 'rgba(121, 248, 248, 0.5)' },
    ...
    { label: 'Les mots respirent (24) 2024-25', value: 1, color: 'rgba(121, 248, 248, 0.5)' },
  ];
