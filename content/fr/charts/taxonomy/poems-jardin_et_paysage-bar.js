...
(async function () {
  const data = [
    ...
    { label: 'Plus loin (16) 2002-04', value: 10, color: 'rgba(121, 248, 248, 0.5)' },
    ...
    { label: 'Kaléidoscopes (29) 2025', value: 0, color: 'rgba(121, 248, 248, 0.5)' },
    { label: 'Tout fait sens (30) 2025-26', value: 2, color: 'rgba(121, 248, 248, 0.5)' },
    { label: 'Emotions mouvantes (31) 2026', value: 2, color: 'rgba(121, 248, 248, 0.5)' },
    { label: 'Témoin jour après jour (32) 2026', value: 0, color: 'rgba(121, 248, 248, 0.5)' },
    { label: 'La musique des mots (33) 2026', value: 0, color: 'rgba(121, 248, 248, 0.5)' },
    { label: 'A mi-chemin du paradis (34) 2026', value: 1, color: 'rgba(121, 248, 248, 0.5)' },
    { label: 'Un jour à la fois (35) 2026', value: 0, color: 'rgba(121, 248, 248, 0.5)' },
  ];
