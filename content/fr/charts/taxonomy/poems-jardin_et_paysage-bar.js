...
(async function () {
  const data = [
    ...
    { label: 'Les mots respirent (24) 2024-25', value: 4, color: 'rgba(121, 248, 248, 0.5)' },
    { label: 'Coeur et âme (25) 2025', value: 1, color: 'rgba(121, 248, 248, 0.5)' },
    { label: 'Chemins non balisés (26) 2025', value: 2, color: 'rgba(121, 248, 248, 0.5)' },
    { label: 'D\'un rêve à l\'autre (27) 2025', value: 1, color: 'rgba(121, 248, 248, 0.5)' },
    { label: 'Les mots sur le chemin (28) 2025', value: 0, color: 'rgba(121, 248, 248, 0.5)' },
  ];
