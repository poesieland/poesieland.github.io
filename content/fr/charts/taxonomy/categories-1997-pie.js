...
(async function () {
  const data = [
    ...
    { label: 'Romantisme', value: 9, color: 'rgba(253, 108, 158, 1)' },
    { label: 'Passion', value: 7, color: 'rgba(199, 44, 72, 1)' },
    { label: 'Aube', value: 4, color: 'rgba(255, 163, 0, 1)' },
    { label: 'Lune', value: 9, color: 'rgba(252, 215, 87, 1)' },
    ...
    { label: 'Espoir', value: 7, color: 'rgba(234, 191, 250, 1)' },
    ...
    { label: 'Temps', value: 13, color: 'rgba(140, 7, 221, 1)' },
    { label: 'Condition humaine', value: 8, color: 'rgba(105, 16, 168, 1)' },
  ...
  addPieChart('categories1997Pie', [data], { plugins: { title: { display: true, text: '1997' } } });
})();
