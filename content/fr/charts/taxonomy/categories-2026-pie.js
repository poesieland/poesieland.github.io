...
(async function () {
  const data = [
    ...
    { label: 'Aube', value: 7, color: 'rgba(255, 203, 96, 1)' },
    ...
    { label: 'Création', value: 17, color: 'rgba(220, 147, 246, 1)' },
    { label: 'Foi', value: 2, color: 'rgba(203, 93, 241, 1)' },
    { label: 'Portraits', value: 4, color: 'rgba(179, 51, 233, 1)' },
    { label: 'Temps', value: 37, color: 'rgba(140, 7, 221, 1)' },
    ...
    { label: 'Angoisse', value: 12, color: 'rgba(38, 9, 78, 1)' },
    ...
    { label: 'Ciel', value: 12, color: 'rgba(119, 181, 254, 1)' },
    { label: 'Faune', value: 22, color: 'rgba(4, 139, 154, 1)' },
    { label: 'Climat', value: 16, color: 'rgb(50, 122, 183, 1)' },
    ...
    { label: 'Eté', value: 21, color: 'rgba(0, 86, 27, 1)' },
