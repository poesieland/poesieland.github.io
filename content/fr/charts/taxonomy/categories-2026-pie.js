...
(async function () {
  const data = [
    ...
    { label: 'Enfance et adolescence', value: 13, color: 'rgba(247, 235, 253, 1)' },
    { label: 'Espoir', value: 5, color: 'rgba(234, 191, 250, 1)' },
    { label: 'Création', value: 18, color: 'rgba(220, 147, 246, 1)' },
    { label: 'Foi', value: 2, color: 'rgba(203, 93, 241, 1)' },
    { label: 'Portraits', value: 6, color: 'rgba(179, 51, 233, 1)' },
    { label: 'Temps', value: 43, color: 'rgba(140, 7, 221, 1)' },
    { label: 'Condition humaine', value: 13, color: 'rgba(105, 16, 168, 1)' },
    { label: 'Apprentissage', value: 7, color: 'rgba(70, 24, 115, 1)' },
    ...
    { label: 'Félinement vôtre', value: 23, color: 'rgba(161, 86, 28, 1)' },
