...
(async function () {
  const data = [
    ...
    { label: 'Huitième Saison : Reflets perdus (1998)', value: 49, color: 'rgba(72, 149, 239, 0.5)' },
    ...
    { label: 'Vingt-troisième Saison : Jamais trop (2024)', value: 2, color: 'rgba(72, 149, 239, 0.5)' },
  ];
