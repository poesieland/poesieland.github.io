...
(async function () {
  const data = [
    ...
    { label: 'Cinquième Saison : Espaces de vie (1997 - 1998)', value: 2, color: 'rgba(119, 181, 254, 0.5)' },
    ...
    { label: 'Vingt-et-unième Saison : C\'est vivre qui compte (2024)', value: 5, color: 'rgba(119, 181, 254, 0.5)' },
  ];
