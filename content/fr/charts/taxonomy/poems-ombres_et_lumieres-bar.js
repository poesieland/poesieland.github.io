...
(async function () {
  const data = [
    ...
    { label: 'Troisième Saison : Vivace (1997)', value: 9, color: 'rgba(255, 203, 96, 0.5)' },
    ...
    { label: 'Vingt-deuxième Saison : Au temps le dire (2024)', value: 8, color: 'rgba(255, 203, 96, 0.5)' },
    { label: 'Vingt-troisième Saison : Jamais trop (2024)', value: 4, color: 'rgba(255, 203, 96, 0.5)' },
    { label: 'Vingt-quatrième Saison : Les mots respirent (2024 - 2025)', value: 1, color: 'rgba(255, 203, 96, 0.5)' },
  ];
