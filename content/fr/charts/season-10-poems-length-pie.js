...
(async function () {
  const data = [
    ...
    { label: '3 quatrains', value: 8, color: 'rgba(72, 149, 239, 0.6000000000000001)' },
    ...
    { label: 'Pas de quatrain car rimes suivies, sonnet, acrostiche découpé différemment', value: 13, color: 'rgba(67, 97, 238, 0.7)' },
  ];
  addPieChart('season10PoemLengthPie', [data], 'En quatrains ?');
})();
