...
(async function () {
  const data = [
    { label: '2 quatrains', value: 5, color: 'rgba(72, 149, 239, 0.5)' },
    ...
    { label: 'Pas de quatrain car rimes suivies, sonnet, acrostiche découpé différemment', value: 11, color: 'rgba(67, 97, 238, 0.7)' },
  ];
