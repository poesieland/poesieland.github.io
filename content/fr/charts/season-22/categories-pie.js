...
(async function () {
  const data = [
    ...
    { label: 'Aube', value: 4, color: 'rgba(255, 163, 0, 1)' },
    ...
    { label: 'Condition humaine', value: 2, color: 'rgba(105, 16, 168, 1)' },
  ...
  addPieChart('season22Pie', [data], { plugins: { title: { display: true, text: 'Au temps le dire (22) septembre à novembre 2024' } } });
})();
