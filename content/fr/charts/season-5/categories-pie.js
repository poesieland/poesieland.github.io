...
(async function () {
  const data = [
    ...
    { label: 'Amour platonique', value: 5, color: 'rgba(255, 111, 125, 1)' },
  ...
  addPieChart('season5Pie', [data], { plugins: { title: { display: true, text: 'Espaces de vie (5) - De septembre 1997 à mars 1998' } } });
})();
