...
(async function () {
  const data = [
    ...
    { label: 'Jardin, paysage', value: 4, color: rgba(74, 214, 109, 1) },
    { label: 'Lune', value: 1, color: rgba(238, 186, 11, 1) },
    { label: 'Musique, chant', value: 2, color: rgba(63, 193, 192, 1) },
    ...
    { label: 'Toucher', value: 3, color: rgba(15, 128, 170, 1) },
    { label: 'Ville', value: 8, color: rgba(195, 111, 9, 1) },
  ];
