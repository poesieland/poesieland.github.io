...
(async function () {
  const data = [
    ...
    { label: 'Mardi', value: 126, color: 'rgba(72, 149, 239, 0.4)' },
    { label: 'Mercredi', value: 136, color: 'rgba(72, 149, 239, 0.5)' },
    ...
    { label: 'Dimanche', value: 142, color: 'rgba(72, 149, 239, 0.9000000000000001)' },
  ];
