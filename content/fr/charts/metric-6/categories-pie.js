...
(async function () {
  const data = [
    ...
    { label: 'Crépuscule', value: 22, color: 'rgba(179, 103, 0, 1)' },
    { label: 'Nuit', value: 8, color: 'rgba(47, 27, 12, 1)' },
    { label: 'Enfance et adolescence', value: 15, color: 'rgba(247, 235, 253, 1)' },
    { label: 'Espoir', value: 28, color: 'rgba(234, 191, 250, 1)' },
    { label: 'Création', value: 27, color: 'rgba(220, 147, 246, 1)' },
    { label: 'Foi', value: 21, color: 'rgba(203, 93, 241, 1)' },
    { label: 'Portraits', value: 26, color: 'rgba(179, 51, 233, 1)' },
    { label: 'Temps', value: 55, color: 'rgba(140, 7, 221, 1)' },
    { label: 'Etre', value: 40, color: 'rgba(105, 16, 168, 1)' },
    { label: 'Apprentissage', value: 15, color: 'rgba(70, 24, 115, 1)' },
