...
(async function () {
  const data = [
    ...
    { label: 'Ville', value: 8, color: 'rgba(139, 91, 41, 1)' },
    ...
    { label: 'Condition humaine', value: 10, color: 'rgba(105, 16, 168, 1)' },
  ...
  addPieChart('season15Pie', [data], { plugins: { title: { display: true, text: 'De place en place (15) avril à décembre 2001' } } });
})();
