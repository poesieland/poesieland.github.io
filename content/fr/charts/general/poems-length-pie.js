...
(async function () {
  const data = [
    ...
    { label: '12', value: 739, color: 'rgb(174, 214, 241)' },
    { label: '14', value: 72, color: 'rgb(163, 228, 215)' },
    { label: '16', value: 393, color: 'rgb(162, 217, 206)' },
    { label: '18', value: 10, color: 'rgb(171, 235, 198)' },
    { label: '20', value: 134, color: 'rgb(249, 231, 159)' },
    { label: '22', value: 2, color: 'rgb(250, 215, 160)' },
    { label: '24', value: 42, color: 'rgb(237, 187, 153)' },
