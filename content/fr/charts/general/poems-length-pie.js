...
(async function () {
  const data = [
    ...
    { label: '8', value: 189, color: 'rgb(215, 189, 226)' },
    { label: '10', value: 61, color: 'rgb(169, 204, 227)' },
    { label: '12', value: 717, color: 'rgb(174, 214, 241)' },
    { label: '14', value: 72, color: 'rgb(163, 228, 215)' },
    { label: '16', value: 387, color: 'rgb(162, 217, 206)' },
    { label: '18', value: 10, color: 'rgb(171, 235, 198)' },
    { label: '20', value: 129, color: 'rgb(249, 231, 159)' },
