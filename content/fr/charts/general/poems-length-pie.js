...
(async function () {
  const data = [
    ...
    { label: '12', value: 753, color: 'rgb(174, 214, 241)' },
    { label: '14', value: 74, color: 'rgb(163, 228, 215)' },
    { label: '16', value: 400, color: 'rgb(162, 217, 206)' },
    { label: '18', value: 10, color: 'rgb(171, 235, 198)' },
    { label: '20', value: 138, color: 'rgb(249, 231, 159)' },
    { label: '22', value: 2, color: 'rgb(250, 215, 160)' },
    { label: '24', value: 43, color: 'rgb(237, 187, 153)' },
