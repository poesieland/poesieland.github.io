...
(async function () {
  const data = [
    ...
    { label: '8', value: 180, color: 'rgb(215, 189, 226)' },
    { label: '10', value: 60, color: 'rgb(169, 204, 227)' },
    { label: '12', value: 672, color: 'rgb(174, 214, 241)' },
    { label: '14', value: 71, color: 'rgb(163, 228, 215)' },
    { label: '16', value: 361, color: 'rgb(162, 217, 206)' },
    { label: '18', value: 10, color: 'rgb(171, 235, 198)' },
    { label: '20', value: 123, color: 'rgb(249, 231, 159)' },
    { label: '22', value: 2, color: 'rgb(250, 215, 160)' },
    { label: '24', value: 36, color: 'rgb(237, 187, 153)' },
