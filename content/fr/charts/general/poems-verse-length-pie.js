...
(async function () {
  const data = [
    ...
    { label: '3 syllabes', value: 15, color: 'rgb(245, 183, 177)' },
    { label: '4 syllabes', value: 72, color: 'rgb(215, 189, 226)' },
    ...
    { label: '8 syllabes', value: 428, color: 'rgb(162, 217, 206)' },
    ...
    { label: '12 syllabes', value: 230, color: 'rgb(237, 187, 153)' },
