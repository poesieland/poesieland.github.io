...
(async function () {
  const data = [
    ...
    { label: '3 syllabes', value: 37, color: 'rgb(245, 183, 177)' },
    { label: '4 syllabes', value: 101, color: 'rgb(215, 189, 226)' },
    { label: '5 syllabes', value: 68, color: 'rgb(169, 204, 227)' },
    { label: '6 syllabes', value: 351, color: 'rgb(174, 214, 241)' },
    { label: '7 syllabes', value: 80, color: 'rgb(163, 228, 215)' },
    { label: '8 syllabes', value: 451, color: 'rgb(162, 217, 206)' },
