...
(async function () {
  const data = [
    ...
    { label: '4 syllabes', value: 125, color: 'rgb(215, 189, 226)' },
    { label: '5 syllabes', value: 101, color: 'rgb(169, 204, 227)' },
    { label: '6 syllabes', value: 393, color: 'rgb(174, 214, 241)' },
    { label: '7 syllabes', value: 83, color: 'rgb(163, 228, 215)' },
    { label: '8 syllabes', value: 482, color: 'rgb(162, 217, 206)' },
