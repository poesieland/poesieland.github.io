...
(async function () {
  const data = [
    ...
    { label: '3 syllabes', value: 52, color: 'rgb(245, 183, 177)' },
    { label: '4 syllabes', value: 132, color: 'rgb(215, 189, 226)' },
    { label: '5 syllabes', value: 105, color: 'rgb(169, 204, 227)' },
    { label: '6 syllabes', value: 403, color: 'rgb(174, 214, 241)' },
    { label: '7 syllabes', value: 83, color: 'rgb(163, 228, 215)' },
    { label: '8 syllabes', value: 486, color: 'rgb(162, 217, 206)' },
