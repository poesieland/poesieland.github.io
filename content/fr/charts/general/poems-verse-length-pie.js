...
(async function () {
  const data = [
    ...
    { label: '2 syllabes', value: 34, color: 'rgb(230, 176, 170)' },
    { label: '3 syllabes', value: 48, color: 'rgb(245, 183, 177)' },
    { label: '4 syllabes', value: 116, color: 'rgb(215, 189, 226)' },
    { label: '5 syllabes', value: 80, color: 'rgb(169, 204, 227)' },
    { label: '6 syllabes', value: 382, color: 'rgb(174, 214, 241)' },
    { label: '7 syllabes', value: 81, color: 'rgb(163, 228, 215)' },
    { label: '8 syllabes', value: 470, color: 'rgb(162, 217, 206)' },
    ...
    { label: '12 syllabes', value: 237, color: 'rgb(237, 187, 153)' },
