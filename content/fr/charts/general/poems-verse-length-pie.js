...
(async function () {
  const data = [
    ...
    { label: '4 syllabes', value: 110, color: 'rgb(215, 189, 226)' },
    { label: '5 syllabes', value: 76, color: 'rgb(169, 204, 227)' },
    { label: '6 syllabes', value: 369, color: 'rgb(174, 214, 241)' },
    ...
    { label: '12 syllabes', value: 235, color: 'rgb(237, 187, 153)' },
