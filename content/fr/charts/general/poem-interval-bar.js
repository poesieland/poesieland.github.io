...
(async function () {
  const data = [
    { label: 'Moins d\'un jour', value: 192, color: 'rgba(72, 149, 239, 1)' },
    { label: 'Un jour', value: 317, color: 'rgba(72, 149, 239, 0.9)' },
    { label: '2j', value: 145, color: 'rgba(72, 149, 239, 0.7)' },
    { label: '3j', value: 103, color: 'rgba(72, 149, 239, 0.7)' },
    { label: '4j', value: 71, color: 'rgba(72, 149, 239, 0.7)' },
    { label: '5j', value: 48, color: 'rgba(72, 149, 239, 0.7)' },
