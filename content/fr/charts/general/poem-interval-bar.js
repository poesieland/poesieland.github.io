...
(async function () {
  const data = [
    { label: 'Moins d\'un jour', value: 318, color: 'rgba(72, 149, 239, 1)' },
    { label: 'Un jour', value: 511, color: 'rgba(72, 149, 239, 0.9)' },
    { label: '2j', value: 199, color: 'rgba(72, 149, 239, 0.7)' },
    { label: '3j', value: 126, color: 'rgba(72, 149, 239, 0.7)' },
    { label: '4j', value: 79, color: 'rgba(72, 149, 239, 0.7)' },
