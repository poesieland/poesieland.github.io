...
(async function () {
  const data = [
    { label: 'Moins d\'un jour', value: 204, color: 'rgba(72, 149, 239, 1)' },
    { label: 'Un jour', value: 336, color: 'rgba(72, 149, 239, 0.9)' },
    { label: '2j', value: 155, color: 'rgba(72, 149, 239, 0.7)' },
    { label: '3j', value: 111, color: 'rgba(72, 149, 239, 0.7)' },
    { label: '4j', value: 74, color: 'rgba(72, 149, 239, 0.7)' },
    { label: '5j', value: 49, color: 'rgba(72, 149, 239, 0.7)' },
