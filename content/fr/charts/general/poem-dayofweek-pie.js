...
(async function () {
  const data = [
    { label: 'Lundi', value: 169, color: 'rgba(72, 149, 239, 0.30000000000000004)' },
    { label: 'Mardi', value: 157, color: 'rgba(72, 149, 239, 0.4)' },
    ...
    { label: 'Samedi', value: 183, color: 'rgba(72, 149, 239, 0.8)' },
    { label: 'Dimanche', value: 200, color: 'rgba(72, 149, 239, 0.9000000000000001)' },
  ];
