...
(async function () {
  const data = [
    ...
    { label: 'Mercredi', value: 149, color: 'rgba(72, 149, 239, 0.5)' },
    { label: 'Jeudi', value: 101, color: 'rgba(72, 149, 239, 0.6000000000000001)' },
    { label: 'Vendredi', value: 127, color: 'rgba(72, 149, 239, 0.7)' },
