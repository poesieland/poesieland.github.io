...
(async function () {
  const data = [
    ...
    { label: 'Vendredi', value: 162, color: 'rgba(72, 149, 239, 0.7)' },
    { label: 'Samedi', value: 191, color: 'rgba(72, 149, 239, 0.8)' },
    { label: 'Dimanche', value: 216, color: 'rgba(72, 149, 239, 0.9000000000000001)' },
  ];
