...
(async function () {
  const data = [
    { label: 'Lundi', value: 174, color: 'rgba(72, 149, 239, 0.30000000000000004)' },
    { label: 'Mardi', value: 163, color: 'rgba(72, 149, 239, 0.4)' },
    { label: 'Mercredi', value: 172, color: 'rgba(72, 149, 239, 0.5)' },
    { label: 'Jeudi', value: 132, color: 'rgba(72, 149, 239, 0.6000000000000001)' },
    { label: 'Vendredi', value: 159, color: 'rgba(72, 149, 239, 0.7)' },
    { label: 'Samedi', value: 189, color: 'rgba(72, 149, 239, 0.8)' },
