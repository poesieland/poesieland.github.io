...
(async function () {
  const data = [
    ...
    { label: 'Mercredi', value: 214, color: 'rgba(72, 149, 239, 0.5)' },
    { label: 'Jeudi', value: 172, color: 'rgba(72, 149, 239, 0.6000000000000001)' },
    { label: 'Vendredi', value: 204, color: 'rgba(72, 149, 239, 0.7)' },
    { label: 'Samedi', value: 248, color: 'rgba(72, 149, 239, 0.8)' },
    { label: 'Dimanche', value: 287, color: 'rgba(72, 149, 239, 0.9000000000000001)' },
  ];
