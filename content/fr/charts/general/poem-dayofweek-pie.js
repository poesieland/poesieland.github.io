...
(async function () {
  const data = [
    ...
    { label: 'Mercredi', value: 180, color: 'rgba(72, 149, 239, 0.5)' },
    { label: 'Jeudi', value: 138, color: 'rgba(72, 149, 239, 0.6000000000000001)' },
    { label: 'Vendredi', value: 165, color: 'rgba(72, 149, 239, 0.7)' },
    { label: 'Samedi', value: 195, color: 'rgba(72, 149, 239, 0.8)' },
    { label: 'Dimanche', value: 226, color: 'rgba(72, 149, 239, 0.9000000000000001)' },
  ];
