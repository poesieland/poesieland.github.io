...
(async function () {
  const data = [
    { label: 'Lundi', value: 182, color: 'rgba(72, 149, 239, 0.30000000000000004)' },
    { label: 'Mardi', value: 174, color: 'rgba(72, 149, 239, 0.4)' },
    { label: 'Mercredi', value: 183, color: 'rgba(72, 149, 239, 0.5)' },
    ...
    { label: 'Dimanche', value: 230, color: 'rgba(72, 149, 239, 0.9000000000000001)' },
  ];
