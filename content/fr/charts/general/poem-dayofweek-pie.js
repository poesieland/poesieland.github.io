...
(async function () {
  const data = [
    ...
    { label: 'Vendredi', value: 146, color: 'rgba(72, 149, 239, 0.7)' },
    { label: 'Samedi', value: 175, color: 'rgba(72, 149, 239, 0.8)' },
    { label: 'Dimanche', value: 195, color: 'rgba(72, 149, 239, 0.9000000000000001)' },
  ];
