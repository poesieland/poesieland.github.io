...
(async function () {
  const data = [
    ...
    { label: 'Mardi', value: 153, color: 'rgba(72, 149, 239, 0.4)' },
    { label: 'Mercredi', value: 161, color: 'rgba(72, 149, 239, 0.5)' },
    { label: 'Jeudi', value: 117, color: 'rgba(72, 149, 239, 0.6000000000000001)' },
    { label: 'Vendredi', value: 140, color: 'rgba(72, 149, 239, 0.7)' },
    { label: 'Samedi', value: 166, color: 'rgba(72, 149, 239, 0.8)' },
    { label: 'Dimanche', value: 186, color: 'rgba(72, 149, 239, 0.9000000000000001)' },
  ];
