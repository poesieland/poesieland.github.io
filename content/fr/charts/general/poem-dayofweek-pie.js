...
(async function () {
  const data = [
    ...
    { label: 'Jeudi', value: 177, color: 'rgba(72, 149, 239, 0.6000000000000001)' },
    { label: 'Vendredi', value: 209, color: 'rgba(72, 149, 239, 0.7)' },
    { label: 'Samedi', value: 259, color: 'rgba(72, 149, 239, 0.8)' },
    { label: 'Dimanche', value: 292, color: 'rgba(72, 149, 239, 0.9000000000000001)' },
  ];
