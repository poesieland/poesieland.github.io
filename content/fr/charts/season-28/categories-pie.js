...
(async function () {
  const data = [
    ...
    { label: 'Apprentissage', value: 6, color: 'rgba(70, 24, 115, 1)' },
    ...
    { label: 'Félinement vôtre', value: 4, color: 'rgba(161, 86, 28, 1)' },
    { label: 'Eté', value: 5, color: 'rgba(0, 86, 27, 1)' },
    { label: 'Automne', value: 16, color: 'rgba(27, 79, 8, 1)' },
    { label: 'Hiver', value: 1, color: 'rgba(24, 57, 30, 1)' },
  ];
  addPieChart('season28Pie', [data], { plugins: { title: { display: true, text: 'Les mots sur le chemin (28) juillet à septembre 2025' } } });
})();
