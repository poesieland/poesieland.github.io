...
(async function () {
  const data = [
    ...
    { label: '3 quatrains', value: 317, color: 'rgba(72, 149, 239, 0.6000000000000001)' },
    { label: '4 quatrains', value: 185, color: 'rgba(72, 149, 239, 0.7000000000000001)' },
    ...
    { label: 'Pas de quatrain car rimes suivies, acrostiche découpé différemment', value: 67, color: 'rgba(67, 97, 238, 0.7)' },
  ];
