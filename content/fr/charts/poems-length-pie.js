...
(async function () {
  const data = [
    ...
    { label: '3 quatrains', value: 367, color: 'rgba(72, 149, 239, 0.6000000000000001)' },
    { label: '4 quatrains', value: 217, color: 'rgba(72, 149, 239, 0.7000000000000001)' },
    ...
    { label: 'Nombre de vers non multiple de quatre', value: 166, color: 'rgba(67, 97, 238, 0.9)' },
