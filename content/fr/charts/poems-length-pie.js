...
(async function () {
  const data = [
    ...
    { label: '3 quatrains', value: 335, color: 'rgba(72, 149, 239, 0.6000000000000001)' },
    { label: '4 quatrains', value: 196, color: 'rgba(72, 149, 239, 0.7000000000000001)' },
    { label: '5 quatrains', value: 52, color: 'rgba(72, 149, 239, 0.8)' },
    { label: '6 quatrains', value: 8, color: 'rgba(72, 149, 239, 0.9)' },
