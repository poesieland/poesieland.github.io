...
(async function () {
  const data = [
    ...
    { label: '2 quatrains', value: 86, color: 'rgba(72, 149, 239, 0.5)' },
    ...
    { label: 'Pas de quatrain car rimes suivies, acrostiche découpé différemment', value: 75, color: 'rgba(67, 97, 238, 0.7)' },
  ];
