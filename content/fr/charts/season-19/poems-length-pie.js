...
(async function () {
  const data = [
    ...
    { label: '2 quatrains', value: 3, color: 'rgba(72, 149, 239, 0.5)' },
    { label: '3 quatrains', value: 19, color: 'rgba(72, 149, 239, 0.6000000000000001)' },
    { label: '4 quatrains', value: 16, color: 'rgba(72, 149, 239, 0.7000000000000001)' },
    ...
    { label: 'Rimes suivies', value: 3, color: 'rgba(67, 97, 238, 0.7)' },
  ];
  addPieChart('season19PoemLengthPie', [data], { plugins: { title: { display: true, text: 'En quatrains ?' } } });
})();
