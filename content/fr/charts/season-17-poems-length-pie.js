...
(async function () {
  const data = [
    ...
    { label: 'Pas de quatrain car rimes suivies, sonnet, acrostiche découpé différemment', value: 4, color: 'rgba(67, 97, 238, 0.7)' },
  ];
  addPieChart('season17PoemLengthPie', [data], 'En quatrains ?');
})();
