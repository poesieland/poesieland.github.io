...
(async function () {
  const data = [
    ...
    { label: 'Amour platonique', value: 9, color: 'rgba(255, 111, 125, 1)' },
    { label: 'Romantisme', value: 17, color: 'rgba(253, 108, 158, 1)' },
    ...
    { label: 'Foi', value: 17, color: 'rgba(203, 93, 241, 1)' },
    { label: 'Portraits', value: 20, color: 'rgba(179, 51, 233, 1)' },
    { label: 'Temps', value: 23, color: 'rgba(140, 7, 221, 1)' },
    { label: 'Etre', value: 31, color: 'rgba(105, 16, 168, 1)' },
    { label: 'Apprentissage', value: 10, color: 'rgba(70, 24, 115, 1)' },
    { label: 'Révolte', value: 7, color: 'rgba(61, 0, 102, 1)' },
    { label: 'Angoisse', value: 13, color: 'rgba(38, 9, 78, 1)' },
    { label: 'Neige', value: 3, color: 'rgba(244, 254, 254, 1)' },
    { label: 'Flore', value: 10, color: 'rgba(84, 114, 174, 1)' },
    { label: 'Jardin et paysage', value: 16, color: 'rgba(121, 248, 248, 1)' },
    { label: 'Eau douce', value: 5, color: 'rgba(0, 127, 255, 1)' },
    { label: 'Ciel', value: 11, color: 'rgba(119, 181, 254, 1)' },
    { label: 'Mer', value: 11, color: 'rgba(0, 127, 255, 1)' },
    { label: 'Faune', value: 3, color: 'rgba(4, 139, 154, 1)' },
    { label: 'Climat', value: 3, color: 'rgb(50, 122, 183, 1)' },
    { label: 'Musique et chant', value: 14, color: 'rgba(252, 191, 140, 1)' },
    ...
    { label: 'Automne', value: 27, color: 'rgba(27, 79, 8, 1)' },
